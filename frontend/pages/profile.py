...
# --- 1. FLOATING SIDEBAR CSS (Same as app.py) ---
st.markdown("""
    <style>
    /* Hide default nav */
...
# --- 2. SIDEBAR CONTENT (Must be present on every page) ---
with st.sidebar:
...
try:
    ...
    with col2:
        ...
        # Logout button
        if st.button("🚪 Logout", use_container_width=True, type="secondary", key="main_logout"):
